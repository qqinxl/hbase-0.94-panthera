...
public class TestFiltersOnDot {
  ...
  private static final byte [][] QUALIFIERS_ONE = {
    Bytes.toBytes("testQualifierOne.0"),
    /*Bytes.toBytes("testQualifierOne.1"),*/
    Bytes.toBytes("testQualifierOne.2"), Bytes.toBytes("testQualifierOne.3")
  };

  private static final byte [][] QUALIFIERS_TWO = {
    Bytes.toBytes("testQualifierTwo.0"),
    /*Bytes.toBytes("testQualifierTwo.1"),*/
  ...
  public void testQualifierFilter() throws IOException {
    ...
    Filter f = new QualifierFilter(CompareOp.EQUAL, new BinaryComparator(
        Bytes.toBytes("testQualifierOne.2")));
    Scan s = new Scan();
    s.setFilter(f);
